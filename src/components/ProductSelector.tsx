    ...
    <section className="section bg-white">
      <div className="container-apple">
        ...
        <div className="text-center mb-12">
          ...
          {/* Selection Counter */}
          <div className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-apple-gray-100 rounded-full">
            <span className="text-body text-apple-gray-600">
              ...
              {Array.from({ length: maxSelection }).map((_, i) => (
                <div
                  ...
                  className={`w-2 h-2 rounded-full transition-colors duration-200 ${
                    i < selectedIds.length ? 'bg-apple-blue' : 'bg-apple-gray-300'
                  }`}
                />
              ))}
            </div>
